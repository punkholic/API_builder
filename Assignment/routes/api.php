...
Route::get('/testView','App\Http\Controllers\BlogBlogController@moreView');

Route::post('/testView2','App\Http\Controllers\BlogBlogController@testView1');

Route::get('/testView5','App\Http\Controllers\BlogBlogController@testView2');

Route::post('/testView3','App\Http\Controllers\BlogBlogController@testView3');

Route::post('/testView4','App\Http\Controllers\BlogBlogController@testView4');
